AFRAME.redisterComponent('drive',{
    init:function () {
    ...
    driveCar: function () {
        ...
        window.addEventListener('keydown', function (e) {
            ...
            //Camera Movement Control: rotation & Direction on Right & Left Arrow
            var cameraRig = document.querySelector("#camera-rig")
            var cameraRotation = cameraRig.getAttribute("rotation")
            var cameraPosition = cameraRig.getAnimation("position")
            var cameraMoveControl = cameraRig.getAttribute("movement-controls")

            console.log(cameraMoveControl.speed)
            cameraRig.setAttribute("movement-controls", {"speed": cameraMoveControl})
            console.log(cameraMoveControl.speed)
            ...
            if(e.code == "ArrowLeft"){
               cameraRotation.y += 5 
               cameraRig.setAttribute("rotation",{x: 0, y: cameraRotation.y, z: 0})
               cameraGir.setAttribute("movement-controls", {"speed": cameraMoveControl.speed + 0.005})
            }
            ...
            if (e.code == "Space") {
                ...
                stopCar.setAttribute("materal", "color", "red")
            }
        })
